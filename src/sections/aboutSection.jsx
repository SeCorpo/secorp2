        ...
        <AnimatedSection>
            <div className="about-section-container">
                <div className="text-content">
                    <h2>About Me</h2>
                    <p>Hello! My name is Sem Koldewijn, and I am currently pursuing a study in Software Development at Hogeschool Utrecht.</p>
                    <p>Throughout my studies, I have worked in teams on fullstack projects, utilizing a variety of technologies and frameworks. These include Java, JavaScript, CSS, HTML, XML, MySQL, NodeJS, and frameworks such as Spring- Boot and Security, Express, Bootstrap, and JavaFX. Additionally, I have experimented with C++, Rust, and Python. Some of my projects can be found on my GitHub profile (/secorpo).</p>
