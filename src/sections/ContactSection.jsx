...
const ContactSection = () => {
    return (
        <AnimatedSection>
            ...
            <ul>
                <li><strong>Email:</strong> sem.koldewijn@example.com</li>
                <li><strong>Phone:</strong> +31 6 12345678</li>
                <li><strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/semkoldewijn" target="_blank" rel="noopener noreferrer">linkedin.com/in/semkoldewijn</a></li>
